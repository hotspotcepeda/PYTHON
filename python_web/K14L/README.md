...
Python 3.12.0
```
**2. Creating virtual environment [`venv`](https://docs.python.org/3/library/venv.html) by PowerShell name venvi**
```
...
(venvi) PS C:\PYTHON\python_web\link_bio>
```
**Reflex run = Reflex Hello Word**
```
(venvi) PS C:\Users\concejal\Documents\Juanjo\PYTHON\python_web\link_bio> reflex run
Info: Overriding config value username with env var USERNAME=alcalde
...
http://localhost:3000
*Backend*
http://localhost:8000/ping   -->   web response "pong"
